...
- [@taffyjs/node API alignment TODOs](api-alignment-todos.md) — the accepted numeric input shorthand awaiting implementation, plus performance and optional API questions that still require evidence.
