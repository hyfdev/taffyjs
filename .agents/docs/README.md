...
- [@taffyjs/node maturity loop goal](loop-goal.md) — the draft exhaustive API, acceptance, test, iteration, review, and finish contract for the unattended implementation run; it is inert until Yunfei vouches the whole file.
