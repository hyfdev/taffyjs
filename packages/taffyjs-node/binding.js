...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-android-arm64/package.json").version;
        if (
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-android-arm-eabi/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-win32-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-win32-x64-msvc/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-win32-ia32-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-win32-arm64-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    try {
      ...
      const bindingPackageVersion =
        require("@taffyjs/binding-darwin-universal/package.json").version;
      if (
        bindingPackageVersion !== "0.0.0" &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-freebsd-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-x64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-arm64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-arm64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-arm-musleabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-arm-gnueabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-riscv64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-linux-riscv64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.0.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-linux-ppc64-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-linux-s390x-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-openharmony-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-openharmony-x64/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@taffyjs/binding-openharmony-arm/package.json").version;
        if (
          bindingPackageVersion !== "0.0.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate("./taffyjs.wasi.cjs", false, [
        "./taffyjs.wasm32-wasi.debug.wasm",
        "./taffyjs.wasm32-wasi.wasm",
      ]);
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    let candidateFailed = false;
    try {
      candidateError = __napiWasiResolveCandidate("@taffyjs/binding-wasm32-wasi", true, undefined);
      candidateFailed = candidateError !== null;
      if (!candidateFailed) {
        if (
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          ...
          const bindingPackageVersion =
            require("@taffyjs/binding-wasm32-wasi/package.json").version;
