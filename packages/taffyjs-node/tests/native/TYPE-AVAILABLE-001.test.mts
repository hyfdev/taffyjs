...
contractTest("TYPE-AVAILABLE-001/axis-record", () => {
  const owner = createOwner();
...
contractTest("TYPE-AVAILABLE-001/helper-conversion", () => {
...
contractTest("TYPE-AVAILABLE-001/definite-value", () => {
...
contractTest("TYPE-AVAILABLE-001/content-extra", () => {
...
contractTest("TYPE-AVAILABLE-001/f32-special", () => {
...
contractTest("TYPE-AVAILABLE-001/whole-value-errors", () => {
