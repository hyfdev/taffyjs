...
contractTest("TYPE-GRID-001/helper-conversion", () => {
...
contractTest("TYPE-GRID-001/strings", () => {
  const text = "列-😀-é";
...
contractTest("TYPE-GRID-001/ownership", () => {
  const track = { min: { kind: 0, value: 10 }, max: { kind: 0, value: 10 } };
  const tracks = [track];
  const lineNames = [["a"], ["b"]];
...
contractTest("TYPE-GRID-001/areas-null", () => {
...
contractTest("TYPE-GRID-001/canonical", () => {
...
contractTest("TYPE-GRID-001/extra-fields", () => {
  const style = storedStyle({
...
contractTest("TYPE-GRID-001/no-css-validation", () => {
