 ...
 * (e.g. `import mod from './taffyjs.wasm32-wasip1.wasm'` under a CompiledWasm
  ...
  try {
    ...
    throw new TypeError(
      "instantiate() and createInstance() expect a precompiled WebAssembly.Module (or a Promise resolving to one), " +
        "e.g. import mod from './taffyjs.wasm32-wasip1.wasm' under a CompiledWasm module rule / wrangler module import. " +
