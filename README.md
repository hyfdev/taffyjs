...
- **Yoga compatibility:** Use `@taffyjs/yoga` or `@taffyjs/yoga-wasm` while preserving Yoga's API shape for straightforward migration.
...
| [`@taffyjs/yoga-wasm`](https://www.npmjs.com/package/@taffyjs/yoga-wasm) | Yoga-compatible API backed by `@taffyjs/wasm`.  | —       |
...
| `@taffyjs/yoga-wasm` | ✅             | ✅       | ✅ (without permission flags)                                               |
