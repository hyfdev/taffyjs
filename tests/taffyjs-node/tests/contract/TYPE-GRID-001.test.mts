...
contractTest("TYPE-GRID-001/families", () => {
...
contractTest("TYPE-GRID-001/minmax", () => {
...
contractTest("TYPE-GRID-001/repeat-lines", () => {
...
contractTest("TYPE-GRID-001/helper-materialization", () => {
  const { GridPlacement, TrackSizingFunction, RepetitionCount, GridTemplateComponent } = helpers();
  for (const value of [
    GridPlacement,
    TrackSizingFunction,
