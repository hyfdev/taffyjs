...
contractTest("API-TREE-006/empty", () => {
...
contractTest("API-TREE-006/ordered-children", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-006/duplicate", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-006/attached", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-006/invalid-id", () => {
...
contractTest("API-TREE-006/failure-atomic", () => {
  const tree = new (TaffyTree())();
