...
contractTest("API-TREE-005/identity", () => {
...
contractTest("API-TREE-005/primitive-null-undefined", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-005/removal-cleanup", () => {
  const fixture = fileURLToPath(
    new URL("./fixtures/api-tree-005-context-lifetime.mjs", import.meta.url),
  );
...
contractTest("API-TREE-005/callback-delivery", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-005/conversion-atomic", () => {
  const tree = new (TaffyTree())();
