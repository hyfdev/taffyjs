...
contractTest("API-TREE-031/stored-output", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-031/rounding", () => {
  const tree = new (TaffyTree())();
  const node = tree.newLeaf({
...
contractTest("API-TREE-031/invalid-root", () => {
...
contractTest("API-TREE-031/invalid-space", () => {
  const tree = new (TaffyTree())();
  const node = tree.newLeaf({
...
contractTest("API-TREE-031/no-measure", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-031/wrapper-atomic", () => {
  const tree = new (TaffyTree())();
