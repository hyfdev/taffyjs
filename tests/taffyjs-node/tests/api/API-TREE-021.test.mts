...
contractTest("API-TREE-021/root-null", () => {
...
contractTest("API-TREE-021/attached", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-021/transitions", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-021/slot-reuse", () => {
  const tree = new (TaffyTree())();
...
contractTest("API-TREE-021/invalid-id", () => {
